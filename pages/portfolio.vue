<template>
  ...
  <div class="flex flex-col">
    ...
    >
      ...
      <img
        :src="el.url"
        alt="Sito Web Alessia Matti Wedding Planner Valle d'Aosta"
...
.front {
  ...
  background-image: url("../assets/AleFront.png");
