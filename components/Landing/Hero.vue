...
import MobileAnimation from "./MobileAnimation.vue";
</script>
...
<template>
  ...
  >
    <div>
      ...
      <h1 class="hero-subtext text-balance mb-4">
...
.hero-img {
  filter: invert(35%) sepia(85%) hue-rotate(179deg);
}
...
.hero-bg {
  background-image: url("../../assets/landing/scroller-bg.png");
